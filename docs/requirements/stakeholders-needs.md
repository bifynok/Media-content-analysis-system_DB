...
| ВИКЛЮЧНІ СИТУАЦІЇ  |Обрані дані відсутні на сайті (можливо DATA_NOT_EXIST) |
| ОСНОВНИЙ СЦЕНАРІЙ: | ОСНОВНИЙ СЦЕНАРІЙ: |1. Редактор входить в панель редагування сайту<br/>2. Редактор вибирає данні для видалення<br/>3. Система перевіряє наявність даних (можливо DATA_NOT_EXIST) <br/>4. Редактор підтверджує видалення|
